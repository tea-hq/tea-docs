...
writing public pages. Its pointers are review aids, not documentation-build inputs,
...
| --- | --- | --- |
| Overview and architecture | `README.md`, `docs/ARCHITECTURE.md`, `ROADMAP.md` | Describe implemented layers and explicit deferrals only. |
| Installation, CLI modes, and TUI | `crates/tea-cli/README.md`, `crates/tea-cli/src/args.rs`, `crates/tea-cli/src/tui/commands.rs`, `crates/tea-cli/src/tui/keymap.rs`, `scripts/package-cli.sh`, `ROADMAP.md` | Verify documented Homebrew and installer endpoints before documentation publication. |
| Configuration and model access | `crates/tea-coding/README.md`, `crates/tea-coding/src/config/`, `crates/tea-cli/src/bootstrap.rs`, `crates/tea-model/README.md` | Use placeholders; never present sensitive values or environment captures. |
| Workspace trust and approvals | `crates/tea-policy/README.md`, `crates/tea-coding-tools/README.md`, `crates/tea-coding/src/trust.rs` | Explain boundaries and user choices without internal operational detail. |
| Sessions, recovery, and branches | `crates/tea-session/README.md`, `crates/tea-session-sqlite/README.md`, `crates/tea-coding/src/service.rs` | Preserve durable-recovery limits and avoid promising unsupported recovery. |
| MCP configuration and lifecycle | `crates/tea-mcp/README.md`, `crates/tea-coding/src/mcp_config.rs`, `crates/tea-cli/src/bootstrap.rs`, `crates/tea-cli/src/tui/commands.rs` | State that configured servers are untrusted and avoid raw internal threat material. |
